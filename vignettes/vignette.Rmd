...
vignette: >
  %\VignetteIndexEntry{Detection of epimutations with state of the art statistics methods in methylation data}
...
|:-----|:--------|:-----:|:------------|:-----|
| Leire | Abarrategui | 0000-0002-1175-038X | Faculty of Medical Sciences, Newcastle University, Newcastle-Upon-Tyne, UK	ISGlobal; ISGlobal, Barcelona Institute for Global Health, Barcelona, Spain | Development |
...
The name of the package is `epimutacions`, that means epimutations in Catalan, a language from the north-eas of Spain.
